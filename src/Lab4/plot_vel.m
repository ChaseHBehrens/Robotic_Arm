...
legend('Actual X Position', 'Expected X Position', 'Actual Y Position', 'Expected Y Position', 'Actual Z Position', 'Expected Z Position')
...
legend('Actual X Velocity', 'Expected X Velocity', 'Actual Y Velocity', 'Expected Y Velocity', 'Actual Z Velocity', 'Expected Z Velocity')
